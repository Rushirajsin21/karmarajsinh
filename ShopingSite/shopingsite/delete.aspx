<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="delete.aspx.cs" Inherits="ShopingSite.delete" %>
...
&nbsp;<asp:TextBox ID="admin_name" runat="server"  class="form-control"  aria-describedby="emailHelp" ReadOnly="true" ></asp:TextBox>
  ...
  <div class="mb-3 col-12">
    ...
    &nbsp;<asp:TextBox ID="Retypepassword" runat="server"  class="form-control" ReadOnly="true" ></asp:TextBox>
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <asp:Button ID="clear" runat="server" Text="Delete" class="btn btn-danger" Width="95px" CausesValidation="False" OnClick="clear_Click" />
